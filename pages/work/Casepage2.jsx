        ...
        <div className="cs-wrap">
          ...
          <div className="cs-hero">
            ...
            <div className="cs-hero-left">
              ...
              {[
                { lbl: "Total Purchases:", val: <><Counter target={738} /> Orders</>, cls: "" },
                { lbl: "CPP (Cost Per Purchase):", val: "11.9 $", cls: "" },
                { lbl: "Sales:", val: "267,726 SAR", cls: "" },
                { lbl: "A.O.V:", val: "360 SAR", cls: "" },
                { lbl: "ROAS:", val: "8.93", cls: "--accent" },
                { lbl: "Total Spend:", val: <><Counter target={8281} prefix="$" />S</>, cls: "--big" },
              ].map((item, i) => (
            ...
            <div className="cs-hero-right">
              <Reveal delay={0.18} dir="left">
                <div className="cs-img-wrap">
                  <img src="/case2.png" alt="Fashion Campaign Dashboard" />
                </div>
              </Reveal>
            </div>
          ...
          <section style={{ marginBottom: 64 }}>
            ...
            <Reveal delay={0.1}>
              <p style={{ color: "rgba(255,255,255,0.58)", lineHeight: 1.8, maxWidth: 680, fontSize: 15, marginBottom: 0 }}>
                A Saudi fashion brand was running Snapchat campaigns with no clear optimization strategy.
                Without proper audience segmentation or creative testing, their CPP was high and ROAS
                was below target — leaving significant revenue on the table.
              </p>
            </Reveal>
            <div className="cs-metrics">
              {[
                { lbl: "Starting ROAS", val: "2.1x" },
                { lbl: "CPP Before", val: "$38" },
                { lbl: "Total Orders", val: "738" },
              ].map((m, i) => (
          ...
          <section style={{ marginBottom: 64 }}>
            ...
            <div className="cs-results">
              {[
                { lbl: "ROAS",        display: "8.93x",        change: "+325%" },
                { lbl: "Total Orders",target: 738,             change: "Purchases" },
                { lbl: "Total Sales", display: "267,726 SAR",  change: "Revenue" },
                { lbl: "Total Spend", display: "$8,281",        change: "Ad Spend" },
              ].map((m, i) => (
                <motion.div
                  key={i}
                  className="cs-rc"
