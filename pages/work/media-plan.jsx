...
Rules: sales=orders*AOV, ROAS=sales/investment. All numbers must be mathematically consistent.`;
  ...
  const S = `
    ...
    .mp{width:100%;min-height:100vh;max-height:100vh;background:#0a0815;color:#fff;font-family:'Sora','Segoe UI',sans-serif;position:relative;overflow-y:auto;overflow-x:hidden;}
