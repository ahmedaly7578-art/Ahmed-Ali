...
const About = () => {
  ...
  return (
    ...
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left overflow-y-auto xl:overflow-visible">
      ...
      {/* ✅ Add mobile padding + spacing only */}
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 px-4 xl:px-0">
        ...
        <div className="flex-1 flex flex-col justify-center gap-y-6 xl:gap-y-0">
          ...
          <motion.p
            ...
            initial="hidden"
            animate="show"
            className="max-w-[500px] mx-auto xl:mx-0 mb-10 xl:mb-12 px-2 xl:px-0"
          >
            I help brands turn data into direction, and ad spend into meaningful growth. With a
            blend of strategic insight, careful optimization, and performance-focused execution,
            I build campaigns that scale, connect with the right audience, and deliver results
        ...
        <motion.div
          ...
          animate="show"
          exit="hidden"
          // ✅ mobile gets height:auto so it can scroll naturally, desktop keeps original height
